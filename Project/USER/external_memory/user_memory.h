...
/* OTA固件生成需要确认的地方 */
#define EF_MEM_VERIFY "effect data V0.1"    // 出货正式版本
// // #define EF_MEM_VERIFY "effect data 2023/11/30  496"


#define DEFAULE_PLAYLIST_NAME "All Effects"
...
void reset_all_built_in_static_effect(void); // 重设全部内置静态灯效颜色数据
...
/*************************************************************************/
//
void get_effect_detail(Efdetail_TypeDef *p, uint8_t efindex);   // 获取灯效详情
void get_effect_brightness1(uint8_t efindex, uint8_t *bright1); // 获取灯效的亮度1
void get_effect_brightness2(uint8_t efindex, uint8_t *bright2); // 获取灯效的亮度2
//
...
//
void modify_effect_brightness(uint8_t efindex, uint8_t bright1, uint8_t bright2); // 修改灯效的亮度信息
void load_current_ef_brightness(void);                                            // 加载当前灯效的亮度
//
/*--------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
// // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // /*
