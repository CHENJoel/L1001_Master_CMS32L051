...
/* OTA固件生成需要确认的地方 */
// #define MCU_VER "1.2.37"         //用户的软件版本,用于MCU固件升级,MCU升级版本需修改
#define MCU_VER "1.2.32"    
...
#define WIFIR_UART_SEND_BUF_LMT         300              //根据用户DP数据大小量定,必须大于48
/******************************************************************************
                        4:定义模块工作方式
模块自处理:
...
//保留4(可下发可上报)
//备注:
#define DPID_RESERVED4 133
//保留5(可下发可上报)
//备注:
#define DPID_RESERVED5 134
//保留6(可下发可上报)
//备注:
#define DPID_RESERVED6 135
//保留7(可下发可上报)
//备注:
#define DPID_RESERVED7 136
//保留8(可下发可上报)
//备注:
#define DPID_RESERVED8 137
//保留9(可下发可上报)
//备注:
#define DPID_RESERVED9 138
//保留10(可下发可上报)
//备注:
#define DPID_RESERVED10 139
