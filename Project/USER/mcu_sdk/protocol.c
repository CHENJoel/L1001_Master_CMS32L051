...
void all_data_update(void)
{
    ...
    mcu_dp_bool_update(DPID_AUTO_BRIGHTNESS_SWITCH,当前自动亮度开关/关闭); //BOOL型数据上报;
    mcu_dp_enum_update(DPID_AUTO_BRIGHTNESS_MODE,当前自动亮度的模式); //枚举型数据上报;
...
/*****************************************************************************
函数名称 : dp_download_auto_brightness_switch_handle
功能描述 : 针对DPID_AUTO_BRIGHTNESS_SWITCH的处理函数
输入参数 : value:数据源数据
        : length:数据长度
返回参数 : 成功返回:SUCCESS/失败返回:ERROR
使用说明 : 可下发可上报类型,需要在处理完数据后上报处理结果至app
...
/*****************************************************************************
函数名称 : dp_download_auto_brightness_mode_handle
功能描述 : 针对DPID_AUTO_BRIGHTNESS_MODE的处理函数
输入参数 : value:数据源数据
        : length:数据长度
返回参数 : 成功返回:SUCCESS/失败返回:ERROR
使用说明 : 可下发可上报类型,需要在处理完数据后上报处理结果至app
